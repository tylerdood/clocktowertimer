    ...
    <div className="flex flex-row justify-center items-center gap-4 mb-2">
      ...
      >
        <div className="relative">
          <img src="/images/townsfolk.png" alt="Townsfolk" className="w-[40px]" />
          <AnimatePresence>
            {showTownsfolkEffect && (
              <motion.div
        ...
        <motion.span
          ...
          className="text-blue-300 text-3xl font-bold drop-shadow-[0_0_4px_rgba(96,165,250,0.8)]"
        >
          {townsfolk} / {outsider}
        </motion.span>
      </motion.div>
      ...
      >
        <div className="relative">
          <img src="/images/evil.png" alt="Evil" className="w-[40px]" />
          <AnimatePresence>
            {showEvilEffect && (
              <motion.div
                className="absolute inset-0 flex items-center justify-center pointer-events-none"
        ...
        <motion.span
          ...
          animate={{ scale: 1, opacity: 1 }}
          transition={{ duration: 0.3 }}
          className="text-red-400 text-3xl font-bold drop-shadow-[0_0_4px_rgba(239,68,68,0.8)]"
        >
          {minion} / {demon}
        </motion.span>
      </motion.div>
      ...
      >
        <div className="relative">
          <img src="/images/travelors.png" alt="Travelers" className="w-[40px]" />
          <AnimatePresence>
            {showTravelerEffect && (
              <motion.div
                className="absolute inset-0 flex items-center justify-center pointer-events-none"
        ...
        <motion.span
          ...
          animate={{ scale: 1, opacity: 1 }}
          transition={{ duration: 0.3 }}
          className="text-yellow-300 text-3xl font-bold drop-shadow-[0_0_4px_rgba(250,204,21,0.8)]"
        >
          {traveler}
        </motion.span>
      </motion.div>
